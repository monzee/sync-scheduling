...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            super(v);
            mLabelTextView = (TextView) v.findViewById(R.id.label_task);
            mStatusTextView = (TextView) v.findViewById(R.id.label_status);
            mDeleteButton = (Button) v.findViewById(R.id.do_delete);
        }
